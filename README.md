...
|:--|:--------|:-------------|:-------------|
| 01 | [**Global GDPpc Forecasting using Deep Learning**](https://github.com/shaikm7d/multivariate-statistical-analysis-of-Medical-and-Pollution-Data) | Hotelling’s T² test, MANOVA, and K-Means clustering performed on medical and pollution dataset after systematic data cleaning and visualization | Python (PyTorch) |
